public class HashTable {
    private static final double constante = 0.7;
    private static final int TAMANHO_TABELA = 31; // Tamanho da tabela hash
    ...
    private int hashFuncao(int chave) {
        double saida = TAMANHO_TABELA*((chave*constante)%1);
        return (int)saida;
    }
